                                         ...
                                         <thead>
                                            ...
                                            <tbody>
                                                 @foreach($scategories as $scategory)
                                                    <tr>
                                                        <td>{{$scategory->id}}</td>
                                                        <td> <img class="icon-img" height="60" src="{{asset('images/categories')}}/{{$scategory->image}}" alt="{{$scategory->name}}"></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="#" onclick="confirm('Are you sure, you want to delete this service category!') || event.stopImmediatePropagation()" wire:click.prevent="deleteServiceCategory({{$scategory->id}})" style="margine-left:10px;"><i class="fa fa-times fa-2x text-danger"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
